...
public class PatchAPK {
    ...
    public int patchAPK(String pathToApkObb, String apkfileName, String configPath, SpecialLabel progressLabel, JDialog parentFrame) {
        String dir = tempPath + "/uber/";

        if (configPath.startsWith("Optional")) {
            ErrorDialog errorDialog = new ErrorDialog();
            errorDialog.errorDialog(parentFrame, "Path to config.json incorrect", "The path to the config.json is incorrect. Set above", 0);
            return -1;
        }
        ...
        // TODO: read file list from the folder instead of that
